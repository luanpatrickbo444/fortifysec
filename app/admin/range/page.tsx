...
export default async function AdminRangePage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
 ...
 return <DashboardShell admin>
  ...
  {(query.template||query.plano||query.ctf||query.skill||query.encerrada)&&<div className="alert success-alert">Configuração do Cyber Range atualizada.</div>}
