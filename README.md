...
- A home `/` renderiza a Academy.
- Aluno autenticado entra em `/dashboard`.
- Administrador autenticado entra em `/admin`.
- `/painel` é mantido como alias para `/dashboard` por compatibilidade.
