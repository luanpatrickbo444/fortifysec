...
import { BookOpen, Boxes, Flag, Gauge, ShieldCheck, Trophy, UserRound, UsersRound, Wrench, GraduationCap, Swords } from 'lucide-react'

export function DashboardShell({children,admin=false}:{children:React.ReactNode,admin?:boolean}){
 const main=[
  ['Visão geral','/painel',Gauge],['Academy','/painel/cursos',GraduationCap],['Labs','/painel/labs',Boxes],['Desafios','/painel/desafios',Swords],['CTF','/painel/ctf',Flag],['Ranking','/painel/ranking',Trophy],['Perfil','/painel/perfil',UserRound]
 ] as const
 const adm=[['Cursos','/admin/cursos',BookOpen],['Aulas','/admin/aulas',GraduationCap],['Matrículas','/admin/matriculas',ShieldCheck],['Usuários','/admin/usuarios',UsersRound],['Labs','/admin/labs',Boxes],['Desafios','/admin/desafios',Wrench],['CTF','/admin/ctf',Flag]] as const
